    ...
    def _match_or_create_global_id(self, camera_id, person_id, features, timestamp):
        ...
        for global_id, stored_features in self.feature_database.items():
            ...
            if last_appearance:
                ...
                similarity = (0.3 * reid_sim + 
                            0.3 * color_sim + 
                            0.3 * time_score +
                            0.1 * transition_bonus)
...
class PersonTracker:
    def __init__(self, video_path, output_base_dir="tracking_results"):
        # Get video name for org anizing output
        ...
        self.max_history_length = 30  # Number of recent features to keep
        ...
        self.min_consecutive_detections = 2  # New parameter
        ...
        self.min_track_duration = 0.5      # Minimum 0.5 seconds
        self.min_detections = 5            # Minimum detections required
        self.track_quality_threshold = 0.4  # Quality threshold
